<script lang="ts">
	...
	import { user, fetchUser, updateUser } from '../../store/index';
...
<div class="progressWrapper">
		...
		<div class="setings_item item-w">
			<div class="item_settings_info">
				...
				<button class="clear_curr max--w" on:click={() => clearField('oldPassword')}
					>{$t('other.clear')}</button
				>
				<button class="clear_curr min--w" on:click={() => clearField('oldPassword')}>X</button>
			</div>
			<input
				class="selected_element input_element"
				type="password"
	...
	<div class="updataBtn">
		<button class="btn_upd" on:click={changePass}>
			{$t('other.save')}
		</button>
		<button class="btn_upd" on:click={clearInputs}>
			{$t('other.cancel')}
		</button>
	</div>
</div>
