...
import { filterStore } from '$src/stores/filterStore';
	...
	const mainSports = [
		'Футбол', 'Хоккей', 'Теннис', 'Баскетбол', 'Волейбол', 'Бейсбол'
	];
	
	const allSports = [
		...mainSports,
		'Американский футбол', 'Бадминтон', 'Бокс', 'Гандбол',
		'Дартс', 'Киберспорт', 'Крикет', 'MMA', 'Настольный теннис',
		'Регби', 'Снукер', 'Формула 1'
	];
