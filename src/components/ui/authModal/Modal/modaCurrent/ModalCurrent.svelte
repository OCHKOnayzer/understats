...
<div class="current_wrapper">
  {#key current_modal}
    {#if current_modal === 'reg'}
      <RegistrationModal switchNext={switchLogin} switchBack={switchRecover} {closeModal} />
    {:else if current_modal === 'login'}
      <LoginModal switchNext={switchReg} switchBack={switchRecover} {closeModal} />
    {:else if current_modal === 'recover'}
      <RecoverModal switchNext={switchLogin} switchBack={switchReg} {switchReFinish} {closeModal} />
