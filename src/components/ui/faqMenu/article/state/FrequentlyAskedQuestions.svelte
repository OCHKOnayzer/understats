...
<div class="article_wrapper">
	...
	<FaqAccordion title="acardion.accounts_and_bets_limits" content="acardion.accounts_and_bets_limits_content"/>
	<FaqAccordion title="acardion.can_i_add_or_edit_bets"/>
	<FaqAccordion title="acardion.extension_installation_time_and_difficulty"/>
	<FaqAccordion title="acardion.tariffs_comparison_and_choice" content="acardion.tariffs_comparison_and_choice_content"/>
